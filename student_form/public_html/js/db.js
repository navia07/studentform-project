...
var token = "enter_token"; // Replace with your actual token
...
function getRollno() {
    ...
    console.log("Roll number entered: " + rollNo);
    if (rollNo) {
        ...
        if (response.status === 200) {
            ...
            console.log("Record not found, enabling Save and Reset buttons.");
